...
def handleclient(clientsocket, clientaddress, clients):
    while True:
        ...
        while running:
            ...
            clients[guessstring] = guessstring
            print(guessstring)
            ...
            for socket, guessstring in clients.items():
                reply = ("You guessed %s.\r\n" % (guess))
...
while 1:
    ...
    clients[socket] = clientaddress
    print("Connection received from: ", clientaddress)
    threading.Thread(target = handleclient, args =  (clientsocket, clientaddress, clients)).start()
