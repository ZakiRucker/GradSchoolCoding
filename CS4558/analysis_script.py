...
ind = np.arange(len(masterDict))  # the x locations for the groups
width = 0.35  # the width of the bars

fig, ax = plt.subplots()
rects1 = ax.bar(ind - width/2, masterDict[0], width, yerr=men_std,
                color='SkyBlue', label='MD 0')
rects2 = ax.bar(ind + width/2, women_masterDict[1], width, yerr=women_std,
                color='IndianRed', label='MD 1')
