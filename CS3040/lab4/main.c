...
#define MAX_NUMS 101//plus one for modulo
#define JUSTIFIED 13//must allow for a 13-digit number
#define ADJUSTIFIED (JUSTIFIED + 1)
#define MAX_UI 4294967295
#define MAX_RANDOM_VALUE 1234567890//must be less than 1234567890(with modulo max will be 1234567889)
#define RED "\x1b[31m"
