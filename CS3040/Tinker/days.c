...
int main(int argc, char *argv[])
{
        ...
        //count the days using a while loop
        //compare argv[1] and argv[2] to month and day
        //increment i until there is a match
        //i now equals the julian date
        int i = 0;
        int j = 0;
        while ((strcmp(argv[1],month[i])==0) && (strcmp(argv[2],j)==0)){
