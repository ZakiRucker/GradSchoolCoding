...
int main (int argc, char *argv[])
{
        ...
        if (isdigit(argv[NUM_OF_LINES][i]) == ZIP){
                        ...
                        exit (-1);
        } else if (strlen(argv[NUM_OF_LINES])>=2){
                if (isdigit(argv[NUM_OF_LINES][i + 1])==0){
                        printf("%c is not a valid digit\n", argv[NUM_OF_LINES][i +1]);
                        exit (-1);
                } else if (strlen(argv[NUM_OF_LINES])>=3){
                        if (isdigit(argv[NUM_OF_LINES][i + 2]==0)){
                                printf("%c is not a valid digit\n", argv[NUM_OF_LINES][i + 2]);
                                exit (-1);
                        } else if (strlen(argv[NUM_OF_LINES])==4){
                                if (isdigit(argv[NUM_OF_LINES][i + 3]==0)){
