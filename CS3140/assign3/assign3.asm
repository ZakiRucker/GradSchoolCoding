...
read:   
        ...
        mov     rdx, 1000       ; set max read length
        mov     rax, 0          ; setup syscode to read
        syscall                 ; execute read call
        cmp     rax, 0
        jz      done
hope:   cmp     rax, 1          ; compare return value to 1
...
write:  
        ;cmp     byte[buf+rcx], 0x0a
        ;jnz     edge
here:        mov     rsi, buf        ; set to write from buf
        mov     rdi, 1          ; to stdout
